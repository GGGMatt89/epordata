...
@section('main_content_page')
  <div class='row'>
    <div class='col-12'>  
      <h3 class='section_title'>Nuova news</h3>
      <hr class='styled-hr'> 
      ...
      <div class='form-row'> 
        <div class="form-group col-12">
          ...
          <input type="date" class="form-control {{ $errors->has('date') ? 'form-error' : ''}}" name="date" id="date" value="{{ old('date') }}" placeholder="Data pubblicazione">
          @error('date')
      ...
      <div class='form-row'> 
        ...
        <div class="col-6 col-md-3 d-flex justify-content-center">
          <div class="preview-container">
            <img id="previewHolder" width="250px" height="170px"  src="/img/news/default.png"/>
          </div>
        </div>  
      </div>
