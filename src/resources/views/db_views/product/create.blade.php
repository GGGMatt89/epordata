      ...
      <form method='POST' action='{{ route("product.store") }}'>
        ...
        <div class='form-row'>
          <div class="form-group col-12">
            ...
            <input type="text" class="form-control {{ $errors->has('name') ? 'form-error' : ''}}" name="name" id="name" value="{{ old('name') }}" placeholder="Nome">
            @error('name')
          ...
          <div class="form-group col-12">
            ...
            <input type="text" class="form-control {{ $errors->has('code') ? 'form-error' : ''}}" name="code" id="code" value="{{ old('code') }}" placeholder="Codice prodotto">
            @error('code')
        ...
        <div class='form-row'>
          <div class="form-group col-6">
            ...
            <select class="selectpicker show-tick form-control {{ $errors->has('type') ? 'form-error' : ''}}" data-size="5" id="type" name="type" value="{{ old('type') }}">
          ...
          <div class="form-group col-6">
            ...
            <select class="selectpicker show-tick form-control {{ $errors->has('category') ? 'form-error' : ''}}" data-size="5" name="category" id="category" value="{{ old('category') }}" placeholder="Categoria prodotto">
        ...
        <div class='form-row'>
          <div class="form-group col-sm-12 col-md-6">
            ...
            <input type="text" class="form-control {{ $errors->has('provider_name') ? 'form-error' : ''}}" name="provider_name" id="provider-name" value="{{ old('provider_name') }}" placeholder="Nome">
            @error('provider_name')
