...
@section('main_content_page')
  <div class='row'>
    <div class='col-12'>
      <h3 class='section_title'>Nuovo fornitore</h3>
      <hr class='styled-hr'>
      <form method='POST' action='{{ route("provider.store") }}'>
        ...
        <div class='form-row'>
          <div class="form-group col-12 col-md-6">
            ...
            <input type="text" class="form-control {{ $errors->has('code') ? 'form-error' : ''}}" name="code" id="code" value="{{ old('code') }}" placeholder="Codice fornitore">
            @error('code')
        ...
        <div class='form-row'>
          <div class="form-group col-12">
            ...
            <select class="selectpicker show-tick form-control {{ $errors->has('category') ? 'form-error' : ''}}"  data-size="5" id="category" name="category" value="{{ old('category') }}">
              <option value=" " selected>Seleziona categoria fornitore</option>
